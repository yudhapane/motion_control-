...

{
	...
	this->addPort("nAxesDesiredPosition_std_outport" , nAxesDesiredPosition_std_outport );
        ...
        this->addEventPort("nAxesJointPosition"  , joint_endpose_port, boost::bind(&nAxesGeneratorPos::moveToOnPort, this)).doc("Activate the trajectory");
        this->addEventPort("nAxesJointPositionDelayed"  , joint_endpose_delayed_port, boost::bind(&nAxesGeneratorPos::moveToDelayedOnPort, this)).doc("Activate the trajectory");
